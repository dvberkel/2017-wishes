...
var _dvberkel$wishes$Tile$isSolved = function (tiles) {
	var isFound = function (t) {
		return t.found;
	};
	var found = A2(_elm_lang$core$List$map, isFound, tiles);
	return A3(
		_elm_lang$core$List$foldr,
		F2(
			function (x, y) {
...
var _dvberkel$wishes$Tile$turnover = function (tiles) {
	var turnover = function (tile) {
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_0: A2(
				...
				function (t) {
					return _dvberkel$wishes$Tile$Tick;
				}),
			_1: {ctor: '[]'}
		});
};
var _dvberkel$wishes$Wish$view = function (model) {
	var solved = _dvberkel$wishes$Tile$isSolved(model.tiles);
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
				...
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_0: _elm_lang$html$Html_Attributes$classList(
							{
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'wish', _1: true},
								_1: {
									ctor: '::',
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(model.wish),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _dvberkel$wishes$Wish$Model = F5(
	function (a, b, c, d, e) {
		return {size: a, seed: b, state: c, tiles: d, wish: e};
	});
...
var _dvberkel$wishes$Wish$init = F2(
	function (ts, wish) {
		return {
			size: _elm_lang$core$List$length(ts),
			seed: _elm_lang$core$Random$initialSeed(0),
			state: _dvberkel$wishes$Wish$Waiting,
			tiles: ts,
			wish: wish
		};
	});
var _dvberkel$wishes$Wish$start = F2(
	function (n, wish) {
		return A2(
			_dvberkel$wishes$Wish$init,
			_dvberkel$wishes$Tile$tiles(n),
			wish);
	});
		...
		switch (_p0.ctor) {
			case 'Waiting':
				var state = function () {
					var _p1 = message;
					if (_p1.ctor === 'Flip') {
						return _dvberkel$wishes$Wish$Inspecting;
					} else {
						return model.state;
					}
				}();
			...
			case 'Inspecting':
				var state = function () {
					var _p2 = message;
					if (_p2.ctor === 'Flip') {
						return _dvberkel$wishes$Wish$Checking;
					} else {
						return model.state;
					}
				}();
			...
			default:
				...
				var tiles = A2(_dvberkel$wishes$Tile$update, _dvberkel$wishes$Tile$TurnOver, model.tiles);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
...
var _dvberkel$wishes$Main$wish = 'Hello, World';
...
if (typeof _dvberkel$wishes$Wish$main !== 'undefined') {
    _dvberkel$wishes$Wish$main(Elm['Wish'], 'Wish', undefined);
}
